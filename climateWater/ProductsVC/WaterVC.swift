...
class WaterVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "WaterProductsVC") as! WaterProductsVC
...
extension WaterVC : UICollectionViewDelegateFlowLayout {
    ...
    func getAllWaterProducts(){
        let getabouturl = "https://climateapp.el-sabat.com/api/categories/1/products".localized
...
extension WaterVC: CollectionViewWater {
