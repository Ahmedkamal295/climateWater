...
class CharityOrderVC: UIViewController,UITextViewDelegate {
    
    @IBOutlet weak var charityOrderView: UIView!
    ...
    override func viewDidLoad() {
        ...
        charityOrderView.layer.shadowColor = UIColor.white.cgColor
        charityOrderView.layer.shadowOpacity = 0.2
        charityOrderView.layer.shadowOffset = .zero
        charityOrderView.layer.shadowRadius = 4
        charityOrderView.layer.shouldRasterize = true
        charityOrderView.layer.rasterizationScale = UIScreen.main.scale
        charityOrderView.layer.cornerRadius = 10
        charityOrderView.layer.borderColor = UIColor.white.cgColor
        charityOrderView.layer.borderWidth = 0.2
